...
func TestDecodesTheAtcrGolden(t *testing.T) {
	doc, err := DecodeTabular(strings.NewReader(atcrGolden))
	if err != nil {
...
func TestDeclaredCountIsAGateInOneDirection(t *testing.T) {
	...
	// allows.
	_, err := DecodeTabular(strings.NewReader("findings[1|]{a}:\n  x\n  y\n"))
	if err == nil {
...
func TestEmptyArrayFormIsNotAnError(t *testing.T) {
	doc, err := DecodeTabular(strings.NewReader("findings[0]:\n"))
	if err != nil {
...
func TestMalformedInputIsAnErrorNotAPanic(t *testing.T) {
	for name, src := range map[string]string{
		...
		t.Run(name, func(t *testing.T) {
			...
			if _, err := DecodeTabular(strings.NewReader(src)); err == nil {
...
func TestDecodeFileReportsTheFileName(t *testing.T) {
	...
	doc, err := DecodeTabularFile(p)
	if err != nil {
		t.Fatalf("DecodeTabularFile: %v", err)
	}
	if len(doc.Rows) != 2 {
...
func TestDuplicateFieldNamesAreAnError(t *testing.T) {
	...
	_, err := DecodeTabular(strings.NewReader("r[1|]{a|b|a}:\n  1|2|3\n"))
	if err == nil {
...
func TestAnEmptyFieldNameIsAnError(t *testing.T) {
	...
	_, err := DecodeTabular(strings.NewReader("r[1|]{}:\n  x\n"))
	if err == nil {
...
func TestALongFieldSurvives(t *testing.T) {
	...
	doc, err := DecodeTabular(strings.NewReader("r[1|]{a|b}:\n  " + long + "|tail\n"))
	if err != nil {
		t.Fatalf("DecodeTabular: %v", err)
	}
...
func TestASiblingLineIsMetadataNotARow(t *testing.T) {
	doc, err := DecodeTabular(strings.NewReader(atcrCLIOutput))
	if err != nil {
...
func TestMoreRowsThanDeclaredIsStillAnError(t *testing.T) {
	...
	_, err := DecodeTabular(strings.NewReader("r[1|]{a}:\n  x\n  y\n"))
	if err == nil {
